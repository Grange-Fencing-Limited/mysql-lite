<?php
    ...
    class SimpleCache {
        ...
        const int FRESHNESS_UNTIL_CLEARED = -2;
        const int FRESHNESS_NEW_DAY = -1;
        ...
        public function __construct(int $freshness = 86400, array $addParams = [], ?string $forcedUri = null) {
            ...
            $this->cacheRoot = $_ENV["API_CACHE_DIR"];
        ...
        private function parseUri($uri): array {
            ...
            $uri = trim($uri, "/");
            // Remove resources/queries/
            $uri = str_replace("resources/api/queries/", "", $uri);
        ...
        private function isFresh(): bool {
            ...
            if (file_exists($filePath)) {
                ...
                if ($this->freshness === self::FRESHNESS_UNTIL_CLEARED) {
                    return true;
                }
                ...
                if (isset($content["timestamp"])) {
                    ...
                    if ($this->freshness === self::FRESHNESS_NEW_DAY) {
        ...
        private function isCacheEnabled(): bool {
            $cacheValue = $_ENV["API_CACHE_ENABLED"] ?? 'true';
